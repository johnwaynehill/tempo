      ...
      >
        <div className="flex items-center gap-2 bg-surface-container rounded-2xl px-4 py-2.5 border border-outline-variant/20 focus-within:border-primary/40 transition-colors">
          <input
            ...
            className="flex-1 bg-transparent text-on-surface text-sm outline-none focus:outline-none focus-visible:outline-none border-none focus:ring-0 placeholder:text-on-surface-variant/40 disabled:opacity-50"
          />
          <button
            type="submit"
